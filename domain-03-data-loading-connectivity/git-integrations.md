...
> **⚠️ TRAMPA DE EXAMEN:** De las tres "integration", esta es la de **código versionado**. Si el caso habla de "definiciones en un repositorio", "versionar" o "desplegar desde Git" → **Git integration** (no storage, no API).
