...
> **⚠️ TRAMPA DE EXAMEN:** Si el escenario menciona "sin exponer/incrustar credenciales", la respuesta es **storage integration**, no meter la llave en el stage. No confundas storage integration con **API** o **Git** integration.
