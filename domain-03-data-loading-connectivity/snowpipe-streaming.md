...
Ingesta de datos **fila por fila** (no por archivos), con **latencia más baja** que Snowpipe clásico. Escribe las filas **directamente** en la tabla mediante un **SDK** (cliente), sin pasar por un stage ni por archivos.
...
> **⚠️ TRAMPA DE EXAMEN:** Streaming **no usa stage ni archivos**. Si el caso dice "filas en vivo, mínima latencia" → Snowpipe **Streaming**; si dice "archivos que llegan continuamente" → Snowpipe clásico.
