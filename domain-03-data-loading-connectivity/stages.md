...
Un **stage** es un **puntero a una ubicación donde viven archivos**, listos para cargarse a una tabla (o donde Snowflake deja los archivos al descargar). No es la tabla: es el "buzón" intermedio entre los archivos y tus datos.
...
> **✅ REGLA RÁPIDA:** Stage = puntero a archivos. `PUT`/`GET` solo con stages **internos**. Para externos, usa una [storage integration](./storage-integrations.md) y deja que la nube deposite los archivos.
