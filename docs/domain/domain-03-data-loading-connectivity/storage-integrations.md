...
Objeto que **guarda de forma segura las credenciales** hacia tu almacenamiento en la nube (el rol de IAM en AWS, la identidad en Azure/GCP), para que tus **stages externos** no lleven llaves de acc[...])
